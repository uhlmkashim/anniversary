...
// stage content:
(lib.sign_effect_3442301 = function() {
	this.initialize();

	// sign
	this.sign_effect = new lib.sign_effect_3442301_1();

	// image_replace
	this.instance = new lib.replace_image_3442301();
...
// symbols:
(lib.replace_image_3442301 = function() {
	this.initialize(img.replace_image_3442301);
...
(lib.reflect_mask_3442301 = function() {
	this.initialize();
...
(lib.reflect_wrapper_3442301 = function() {
	this.initialize();
...
(lib.sign_effect_3442301_1 = function() {
	this.initialize();
