...
// stage content:
(lib.sign_effect_3516102 = function() {
	this.initialize();

	// sign
	this.sign_effect = new lib.sign_effect_3516102_1();

	// image_replace
	this.instance = new lib.replace_image_3516102();

	this.addChild(this.instance,this.sign_effect);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,672.4,800);


// symbols:
(lib.replace_image_3516102 = function() {
	this.initialize(img.replace_image_3516102);
...
(lib.reflect_mask_3516102 = function() {
	this.initialize();
...
(lib.reflect_wrapper_3516102 = function() {
	this.initialize();
...
(lib.sign_effect_3516102_1 = function() {
	this.initialize();

	// glitter
	this.instance = new lib.glitter_wrapper();
	this.instance.setTransform(421.6,486.9,0.596,0.596);

	this.instance_1 = new lib.glitter_wrapper();
	this.instance_1.setTransform(333.4,568.6,0.902,0.902);

	this.instance_2 = new lib.glitter_wrapper();
	this.instance_2.setTransform(621.8,571,0.902,0.902);

	this.instance_3 = new lib.glitter_wrapper();
	this.instance_3.setTransform(588.6,497.5,0.902,0.902);

	this.instance_4 = new lib.glitter_wrapper();
	this.instance_4.setTransform(493.5,510.5,0.654,0.654);

	this.instance_5 = new lib.glitter_wrapper();
	this.instance_5.setTransform(549.2,546.7,0.625,0.625);

	this.instance_6 = new lib.glitter_wrapper();
	this.instance_6.setTransform(386.7,539.2,0.596,0.596);

	this.instance_7 = new lib.glitter_wrapper();
	this.instance_7.setTransform(621.8,466.3,0.902,0.902);

	this.instance_8 = new lib.glitter_wrapper();
	this.instance_8.setTransform(337.6,460.9,0.902,0.902);
...
p.nominalBounds = new cjs.Rectangle(282.8,134,389.7,764.1);
