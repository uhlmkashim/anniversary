...
// stage content:
(lib.sign_effect_3542302 = function() {
	this.initialize();

	// sign
	this.sign_effect = new lib.sign_effect_3542302_1();

	// image_replace
	this.instance = new lib.replace_image_3542302();

	this.addChild(this.instance,this.sign_effect);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-42.3,0,682.3,800);


// symbols:
(lib.replace_image_3542302 = function() {
	this.initialize(img.replace_image_3542302);
...
(lib.reflect_mask_3542302 = function() {
	this.initialize();
...
(lib.reflect_wrapper_3542302 = function() {
	this.initialize();
...
(lib.sign_effect_3542302_1 = function() {
	this.initialize();

	// glitter
	this.instance = new lib.glitter_wrapper();
	this.instance.setTransform(93.3,572,0.582,0.582);

	this.instance_1 = new lib.glitter_wrapper();
	this.instance_1.setTransform(7.1,651.9,0.882,0.882);

	this.instance_2 = new lib.glitter_wrapper();
	this.instance_2.setTransform(288.9,654.2,0.882,0.882);

	this.instance_3 = new lib.glitter_wrapper();
	this.instance_3.setTransform(256.4,582.4,0.882,0.882);

	this.instance_4 = new lib.glitter_wrapper();
	this.instance_4.setTransform(163.5,595.1,0.639,0.639);

	this.instance_5 = new lib.glitter_wrapper();
	this.instance_5.setTransform(218,630.5,0.611,0.611);

	this.instance_6 = new lib.glitter_wrapper();
	this.instance_6.setTransform(59.2,623.1,0.582,0.582);

	this.instance_7 = new lib.glitter_wrapper();
	this.instance_7.setTransform(288.9,551.9,0.882,0.882);

	this.instance_8 = new lib.glitter_wrapper();
	this.instance_8.setTransform(11.2,546.7,0.882,0.882);
...
p.nominalBounds = new cjs.Rectangle(-42.3,227.7,380.7,750.5);
