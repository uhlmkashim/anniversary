...
// stage content:
(lib.sign_effect_3542402 = function() {
	this.initialize();

	// sign
	this.sign_effect = new lib.sign_effect_3542402_1();

	// image_replace
	this.instance = new lib.replace_image_3542402();
...
// symbols:
(lib.replace_image_3542402 = function() {
	this.initialize(img.replace_image_3542402);
...
(lib.reflect_mask_3542402 = function() {
	this.initialize();
...
(lib.reflect_wrapper_3542402 = function() {
	this.initialize();
...
(lib.sign_effect_3542402_1 = function() {
	this.initialize();
