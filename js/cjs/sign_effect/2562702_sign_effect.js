...
}).prototype = getMCSymbolPrototype(lib.reflect_mask, new cjs.Rectangle(-162.4,-62.4,324.9,124.8), null);
...
}).prototype = getMCSymbolPrototype(lib.reflect, new cjs.Rectangle(0,-404.8,324.9,809.7), null);
...
}).prototype = getMCSymbolPrototype(lib.reflect_wrapper, new cjs.Rectangle(0,-404.8,324.9,809.7), null);
...
}).prototype = getMCSymbolPrototype(lib.sign_effect, new cjs.Rectangle(32,162.1,636.7,747.6999999999999), null);
...
(lib.replace = function(mode,startPosition,loop) {
	...
	// image_replace
	this.instance = new lib.replace_image2562702_();
	this.instance.parent = this;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.replace, new cjs.Rectangle(0,0,668.7,977.1), null);


// stage content:
(lib._2562702_sign_effect = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/replace_image2562702_.jpg", id:"_2562702_sign_effect_replace_image2562702_"}
	],
	preloads: []
};
...
an.compositions['_2562702_sign_effect'] = {
