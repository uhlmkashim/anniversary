...
(lib.reflect_mask = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(0.008,0.0142);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.reflect_mask, new cjs.Rectangle(-158.5,-61.7,317,123.4), null);
...
}).prototype = getMCSymbolPrototype(lib.reflect, new cjs.Rectangle(0,-395,317,790.1), null);
...
}).prototype = getMCSymbolPrototype(lib.reflect_wrapper, new cjs.Rectangle(0,-395,317,790.1), null);
...
}).prototype = getMCSymbolPrototype(lib.sign_effect, new cjs.Rectangle(32,162.1,646,747.6999999999999), null);
...
(lib.replace = function(mode,startPosition,loop) {
	...
	// image_replace
	this.instance = new lib.replace_image2462701_();
	this.instance.parent = this;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.replace, new cjs.Rectangle(0,0,678,970.9), null);


// stage content:
(lib._2462701_sign_effect = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/replace_image2462701_.jpg", id:"_2462701_sign_effect_replace_image2462701_"}
	],
	preloads: []
};
...
an.compositions['_2462701_sign_effect'] = {
