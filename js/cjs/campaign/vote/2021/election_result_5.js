(function(a, l) {
    ...
    (b._005_shuttle_cu = function() {
        this.initialize(m.election_result_5__005_shuttle_cu)
    }).prototype = f = new a.Bitmap;
    f.nominalBounds = new a.Rectangle(0, 0, 392, 392);
    (b._005_textflame =
        function() {
            this.initialize(m.election_result_5__005_textflame)
        }).prototype = f = new a.Bitmap;
    f.nominalBounds = new a.Rectangle(0, 0, 432, 206);
    (b.bg = function() {
        this.initialize(m.election_result_5_bg)
    }).prototype = f = new a.Bitmap;
    f.nominalBounds = new a.Rectangle(0, 0, 480, 640);
    (b.bottom = function() {
        this.initialize(m.election_result_5_bottom)
    }).prototype = f = new a.Bitmap;
    f.nominalBounds = new a.Rectangle(0, 0, 480, 182);
    (b.fp_flower3 = function() {
        this.initialize(m.election_result_5_fp_flower3)
    }).prototype = f = new a.Bitmap;
    f.nominalBounds = new a.Rectangle(0, 0, 24, 22);
    (b.result_ch5 = function() {
        this.initialize(m.election_result_5_result_ch5)
    }).prototype = f = new a.Bitmap;
    f.nominalBounds = new a.Rectangle(0, 0, 480, 620);
    (b.result_ch5_black = function() {
        this.initialize(m.election_result_5_result_ch5_black)
    }).prototype = f = new a.Bitmap;
    f.nominalBounds = new a.Rectangle(0, 0, 480, 620);
    (b.result_ch5_white = function() {
        this.initialize(m.election_result_5_result_ch5_white)
    }).prototype = f = new a.Bitmap;
    f.nominalBounds = new a.Rectangle(0, 0, 480, 620);
    (b.result_name5 = function() {
        this.initialize(m.election_result_5_result_name5)
    }).prototype = f = new a.Bitmap;
    f.nominalBounds = new a.Rectangle(0, 0, 480, 101);
    (b.result_no5 = function() {
        this.initialize(m.election_result_5_result_no5)
    }).prototype = f = new a.Bitmap;
    f.nominalBounds = new a.Rectangle(0, 0, 286, 144);
    (b.result_no5_white = function() {
        this.initialize(m.election_result_5_result_no5_white)
    }).prototype = f = new a.Bitmap;
    f.nominalBounds = new a.Rectangle(0, 0, 286, 144);
    (b.result_sign5 = function() {
        this.initialize(m.election_result_5_result_sign5)
    }).prototype =
        f = new a.Bitmap;
    f.nominalBounds = new a.Rectangle(0, 0, 250, 142);
    (b.result_votes5 = function() {
        this.initialize(m.election_result_5_result_votes5)
    }).prototype = f = new a.Bitmap;
    f.nominalBounds = new a.Rectangle(0, 0, 422, 74);
    (b.sp_kirakira = function() {
        this.initialize(m.election_result_5_sp_kirakira)
    }).prototype = f = new a.Bitmap;
    ...
    }).prototype = g(b.\u30d1\u30fc\u30c6\u30a3\u30af\u30eb_pp, new a.Rectangle(-5.2, -179.6, 149,
        185.2), null);
    ...
    (b.rank_all_white = function(c, d, e) {
        this.initialize(c,
            d, e, {});
        this.instance = new b.result_no5_white;
        this.instance.parent = this;
        this.instance.setTransform(-72, -72, .5, .5);
        this.timeline.addTween(a.Tween.get(this.instance).wait(1))
    }).prototype = g(b.rank_all_white, new a.Rectangle(-72, -72, 143, 72), null);
    (b.particle_trace_core = function(c, d, e) {
        this.initialize(c, d, e, {});
        this.shape = new a.Shape;
        this.shape.graphics.f("#FFFFFF").s().p("AgLAMIAAgXIAXAAIAAAXg");
        this.timeline.addTween(a.Tween.get(this.shape).wait(1))
    }).prototype = g(b.particle_trace_core, new a.Rectangle(-1.2,
        -1.2, 2.4, 2.4), null);
    ...
    (b.gr_number =
        function(c, d, e) {
            this.initialize(c, d, e, {});
            this.instance = new b.result_name5;
            this.instance.parent = this;
            this.instance.setTransform(-240, -101);
            this.timeline.addTween(a.Tween.get(this.instance).wait(1))
        }).prototype = g(b.gr_number, new a.Rectangle(-240, -101, 480, 101), null);
    (b.gr_base = function(c, d, e) {
        ...
        this.timeline.addTween(a.Tween.get(this.instance).wait(1))
    }).prototype = g(b.gr_base, new a.Rectangle(-120,
        -91, 240, 91), null);
    ...
    (b.ef_glow_white = function(c, d, e) {
        this.initialize(c, d, e, {});
        this.shape = new a.Shape;
        this.shape.graphics.rf(["#FFFFFF", "#FFFFFF", "rgba(255,255,255,0)",
            "rgba(255,255,255,0)"
    ...
    (b.cursor_white = function(c, d, e) {
        ...
        this.timeline.addTween(a.Tween.get(this.shape).wait(1))
    }).prototype = g(b.cursor_white, new a.Rectangle(-8.5, -8.5, 17, 8.5), null);
    (b.cursor_black = function(c, d, e) {
        ...
        this.timeline.addTween(a.Tween.get(this.shape_1).wait(1))
    }).prototype = g(b.cursor_black, new a.Rectangle(-50.7, -52.3, 88.7, 85.19999999999999), null);
    ...
    (b.bg_gra = function(c, d, e) {
        ...
        this.timeline.addTween(a.Tween.get(this.instance).wait(1))
    }).prototype = g(b.bg_gra, new a.Rectangle(0, 0, 240, 320),
        null);
    ...
    (b.___rank = function(c, d, e) {
        this.initialize(c, d, e, {});
        this.instance = new b.result_no5;
        this.instance.parent = this;
        this.instance.setTransform(-72, -72, .5, .5);
        this.timeline.addTween(a.Tween.get(this.instance).wait(1))
    ...
    (b.___character_white = function(c, d, e) {
        this.initialize(c, d, e, {});
        this.instance = new b.result_ch5_white;
        this.instance.parent = this;
        this.instance.setTransform(-263, -620);
        this.timeline.addTween(a.Tween.get(this.instance).wait(1))
    }).prototype = g(b.___character_white, new a.Rectangle(-263, -620, 480, 620), null);
    (b.___character_black = function(c, d, e) {
        this.initialize(c, d, e, {});
        this.instance = new b.result_ch5_black;
        this.instance.parent = this;
        this.instance.setTransform(-263, -620);
        this.timeline.addTween(a.Tween.get(this.instance).wait(1))
    }).prototype =
        g(b.___character_black, new a.Rectangle(-263, -620, 480, 620), null);
    (b.___character = function(c, d, e) {
        this.initialize(c, d, e, {});
        this.instance = new b.result_ch5;
        this.instance.parent = this;
        this.instance.setTransform(-263, -620);
        this.timeline.addTween(a.Tween.get(this.instance).wait(1))
    }).prototype = g(b.___character, new a.Rectangle(-263, -620, 480, 620), null);
    ...
    (b.rank_all = function(c, d, e) {
        ...
        this.timeline.addTween(a.Tween.get(this.instance_1).wait(1))
    }).prototype = g(b.rank_all, new a.Rectangle(-117.3, -72.9, 234.6, 86.4), null);
    ...
    (b.election_result_5 = function(c, d, e) {
        this.initialize(c, d, e, {
            top5_1: 3,
            top5_2: 25,
            top5_3: 49,
    ...
    b.properties = {
        ...
        manifest: [{
                ...
                id: "election_result_5__005_shuttle_cu"
            }, {
                src: "images/_005_textflame.png",
                id: "election_result_5__005_textflame"
            }, {
                src: "images/bg.jpg",
                id: "election_result_5_bg"
            }, {
                src: "images/bottom.png",
                id: "election_result_5_bottom"
            }, {
                src: "images/fp_flower3.png",
                id: "election_result_5_fp_flower3"
            },
            {
                src: "images/result_ch5.png",
                id: "election_result_5_result_ch5"
            }, {
                src: "images/result_ch5_black.png",
                id: "election_result_5_result_ch5_black"
            }, {
                src: "images/result_ch5_white.png",
                id: "election_result_5_result_ch5_white"
            }, {
                src: "images/result_name5.png",
                id: "election_result_5_result_name5"
            }, {
                src: "images/result_no5.png",
                id: "election_result_5_result_no5"
            }, {
                src: "images/result_no5_white.png",
                id: "election_result_5_result_no5_white"
            }, {
                src: "images/result_sign5.png",
                id: "election_result_5_result_sign5"
            }, {
                src: "images/result_votes5.png",
                id: "election_result_5_result_votes5"
            }, {
                src: "images/sp_kirakira.png",
                id: "election_result_5_sp_kirakira"
            }
        ],
        preloads: []
    };
    ...
    l.compositions.election_result_5 = {
        getStage: function() {
