(function(a, l) {
    ...
    (b._005_shuttle_cu = function() {
        this.initialize(m.voice_election_result_2__005_shuttle_cu)
    }).prototype = f = new a.Bitmap;
    f.nominalBounds = new a.Rectangle(0, 0, 392, 392);
    (b._005_textflame =
        function() {
            this.initialize(m.voice_election_result_2__005_textflame)
        }).prototype = f = new a.Bitmap;
    f.nominalBounds = new a.Rectangle(0, 0, 432, 206);
    (b.bg = function() {
        this.initialize(m.voice_election_result_2_bg)
    }).prototype = f = new a.Bitmap;
    f.nominalBounds = new a.Rectangle(0, 0, 480, 640);
    (b.bottom = function() {
        this.initialize(m.voice_election_result_2_bottom)
    }).prototype = f = new a.Bitmap;
    f.nominalBounds = new a.Rectangle(0, 0, 480, 182);
    (b.fp_flower3 = function() {
        this.initialize(m.voice_election_result_2_fp_flower3)
    }).prototype =
        f = new a.Bitmap;
    f.nominalBounds = new a.Rectangle(0, 0, 24, 22);
    (b.result_ch2 = function() {
        this.initialize(m.voice_election_result_2_result_ch2)
    }).prototype = f = new a.Bitmap;
    f.nominalBounds = new a.Rectangle(0, 0, 580, 620);
    (b.result_ch2_black = function() {
        this.initialize(m.voice_election_result_2_result_ch2_black)
    }).prototype = f = new a.Bitmap;
    f.nominalBounds = new a.Rectangle(0, 0, 580, 620);
    (b.result_ch2_white = function() {
        this.initialize(m.voice_election_result_2_result_ch2_white)
    }).prototype = f = new a.Bitmap;
    f.nominalBounds =
        new a.Rectangle(0, 0, 580, 620);
    (b.result_name2 = function() {
        this.initialize(m.voice_election_result_2_result_name2)
    }).prototype = f = new a.Bitmap;
    f.nominalBounds = new a.Rectangle(0, 0, 480, 102);
    (b.result_no2 = function() {
        this.initialize(m.voice_election_result_2_result_no2)
    }).prototype = f = new a.Bitmap;
    f.nominalBounds = new a.Rectangle(0, 0, 286, 146);
    (b.result_no2_white = function() {
        this.initialize(m.voice_election_result_2_result_no2_white)
    }).prototype = f = new a.Bitmap;
    f.nominalBounds = new a.Rectangle(0, 0, 286, 146);
    (b.result_sign2 =
        function() {
            this.initialize(m.voice_election_result_2_result_sign2)
        }).prototype = f = new a.Bitmap;
    f.nominalBounds = new a.Rectangle(0, 0, 284, 103);
    (b.result_votes2 = function() {
        this.initialize(m.voice_election_result_2_result_votes2)
    }).prototype = f = new a.Bitmap;
    f.nominalBounds = new a.Rectangle(0, 0, 422, 74);
    (b.sp_kirakira = function() {
        this.initialize(m.voice_election_result_2_sp_kirakira)
    }).prototype = f = new a.Bitmap;
    f.nominalBounds = new a.Rectangle(0, 0, 40, 40);
    (b.\u30d1\u30fc\u30c6\u30a3\u30af\u30eb_pp = function(c, d,
        e) {
    ...
    (b.sign = function(c, d, e) {
        ...
        this.instance.setTransform(-153, -14);
        this.timeline.addTween(a.Tween.get(this.instance).wait(1))
    }).prototype = g(b.sign, new a.Rectangle(-153, -14, 284, 103), null);
    ...
    (b.bg_gra = function(c, d, e) {
        ...
        g(b.bg_gra, new a.Rectangle(0, 0, 240, 320), null);
    ...
    (b.___character_white = function(c, d, e) {
        ...
        this.instance.parent = this;
        this.instance.setTransform(-230, -620);
        this.timeline.addTween(a.Tween.get(this.instance).wait(1))
    }).prototype = g(b.___character_white, new a.Rectangle(-230, -620, 580, 620), null);
    (b.___character_black = function(c, d, e) {
        ...
        g(b.___character_black, new a.Rectangle(-230, -620, 580, 620), null);
    (b.___character = function(c, d, e) {
        ...
        this.instance.setTransform(-230, -620);
        this.timeline.addTween(a.Tween.get(this.instance).wait(1))
    }).prototype = g(b.___character, new a.Rectangle(-230, -620, 580, 620), null);
    ...
    (b._bg2 = function(c, d, e) {
        ...
        g(b._bg2, new a.Rectangle(0, 0, 806, 320), null);
    ...
    (b.rank_all = function(c, d, e) {
        ...
        this.timeline.addTween(a.Tween.get(this.instance_1).wait(1))
    }).prototype = g(b.rank_all, new a.Rectangle(-117.3, -86.3, 234.6, 86.39999999999999), null);
    (b.kirakira_mov_all = function(c, d, e) {
        ...
        this.instance = new b.kirakira_mov;
        this.instance.parent = this;
        this.instance.setTransform(-67.2, 145.15,
            .281, .281);
        this.timeline.addTween(a.Tween.get(this.instance).wait(36));
        this.instance_1 = new b.kirakira_mov;
        this.instance_1.parent = this;
    ...
    (b.voice_election_result_2 = function(c, d, e) {
        this.initialize(c, d, e, {
            top5_1: 3,
            top5_2: 25,
            top5_3: 49,
    ...
    b.properties = {
        ...
        manifest: [{
                ...
                id: "voice_election_result_2__005_shuttle_cu"
            }, {
                src: "images/_005_textflame.png",
                id: "voice_election_result_2__005_textflame"
            }, {
                src: "images/bg.jpg",
                id: "voice_election_result_2_bg"
            }, {
                src: "images/bottom.png",
                id: "voice_election_result_2_bottom"
            }, {
                src: "images/fp_flower3.png",
                id: "voice_election_result_2_fp_flower3"
            }, {
                src: "images/result_ch2.png",
                id: "voice_election_result_2_result_ch2"
            }, {
                src: "images/result_ch2_black.png",
                id: "voice_election_result_2_result_ch2_black"
            }, {
                src: "images/result_ch2_white.png",
                id: "voice_election_result_2_result_ch2_white"
            }, {
                src: "images/result_name2.png",
                id: "voice_election_result_2_result_name2"
            }, {
                src: "images/result_no2.png",
                id: "voice_election_result_2_result_no2"
            }, {
                src: "images/result_no2_white.png",
                id: "voice_election_result_2_result_no2_white"
            },
            {
                src: "images/result_sign2.png",
                id: "voice_election_result_2_result_sign2"
            }, {
                src: "images/result_votes2.png",
                id: "voice_election_result_2_result_votes2"
            }, {
                src: "images/sp_kirakira.png",
                id: "voice_election_result_2_sp_kirakira"
            }
        ],
        preloads: []
    };
    ...
    l.compositions.voice_election_result_2 = {
        getStage: function() {
    ...
    l.makeResponsive = function(c, d, e, q, p) {
        function n() {
            var r = b.properties.width,
                ...
                k = 1;
            if (c)
                if ("width" == d && t == x || "height" == d && u == y) k = v;
