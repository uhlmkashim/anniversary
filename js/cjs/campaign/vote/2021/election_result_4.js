(function(a, l) {
    ...
    (b._005_shuttle_pa = function() {
        this.initialize(m.election_result_4__005_shuttle_pa)
    }).prototype = f = new a.Bitmap;
    f.nominalBounds = new a.Rectangle(0, 0, 392, 392);
    (b._005_textflame =
        function() {
            this.initialize(m.election_result_4__005_textflame)
        }).prototype = f = new a.Bitmap;
    f.nominalBounds = new a.Rectangle(0, 0, 432, 206);
    (b.bg = function() {
        this.initialize(m.election_result_4_bg)
    }).prototype = f = new a.Bitmap;
    f.nominalBounds = new a.Rectangle(0, 0, 480, 640);
    (b.bottom = function() {
        this.initialize(m.election_result_4_bottom)
    }).prototype = f = new a.Bitmap;
    f.nominalBounds = new a.Rectangle(0, 0, 480, 182);
    (b.fp_flower3 = function() {
        this.initialize(m.election_result_4_fp_flower3)
    }).prototype = f = new a.Bitmap;
    f.nominalBounds = new a.Rectangle(0, 0, 24, 22);
    (b.result_ch4 = function() {
        this.initialize(m.election_result_4_result_ch4)
    }).prototype = f = new a.Bitmap;
    f.nominalBounds = new a.Rectangle(0, 0, 748, 620);
    (b.result_ch4_black = function() {
        this.initialize(m.election_result_4_result_ch4_black)
    }).prototype = f = new a.Bitmap;
    f.nominalBounds = new a.Rectangle(0, 0, 748, 620);
    (b.result_ch4_white = function() {
        this.initialize(m.election_result_4_result_ch4_white)
    }).prototype = f = new a.Bitmap;
    f.nominalBounds = new a.Rectangle(0, 0, 748, 620);
    (b.result_name4 = function() {
        this.initialize(m.election_result_4_result_name4)
    }).prototype = f = new a.Bitmap;
    f.nominalBounds = new a.Rectangle(0, 0, 430, 102);
    (b.result_no4 = function() {
        this.initialize(m.election_result_4_result_no4)
    }).prototype = f = new a.Bitmap;
    f.nominalBounds = new a.Rectangle(0, 0, 286, 146);
    (b.result_no4_white = function() {
        this.initialize(m.election_result_4_result_no4_white)
    }).prototype = f = new a.Bitmap;
    f.nominalBounds = new a.Rectangle(0, 0, 286, 146);
    (b.result_sign4 = function() {
        this.initialize(m.election_result_4_result_sign4)
    }).prototype =
        f = new a.Bitmap;
    f.nominalBounds = new a.Rectangle(0, 0, 307, 75);
    (b.result_votes4 = function() {
        this.initialize(m.election_result_4_result_votes4)
    }).prototype = f = new a.Bitmap;
    f.nominalBounds = new a.Rectangle(0, 0, 422, 74);
    (b.sp_kirakira = function() {
        this.initialize(m.election_result_4_sp_kirakira)
    }).prototype = f = new a.Bitmap;
    ...
    (b.sign = function(c, d, e) {
        this.initialize(c, d, e, {});
        this.instance = new b.result_sign4;
        this.instance.parent = this;
        this.instance.setTransform(-174,
            -12);
        this.timeline.addTween(a.Tween.get(this.instance).wait(1))
    }).prototype = g(b.sign, new a.Rectangle(-174, -12, 307, 75), null);
    ...
    (b.rank_all_white = function(c, d, e) {
        this.initialize(c,
            d, e, {});
        this.instance = new b.result_no4_white;
        this.instance.parent = this;
    ...
    (b.gr_votes = function(c, d, e) {
        this.initialize(c, d, e, {});
        this.instance = new b.result_votes4;
        this.instance.parent = this;
    ...
    (b.gr_shuttle = function(c,
        ...
        this.instance = new b._005_shuttle_pa;
        this.instance.parent = this;
    ...
    (b.gr_number =
        function(c, d, e) {
            this.initialize(c, d, e, {});
            this.instance = new b.result_name4;
            this.instance.parent = this;
            this.instance.setTransform(-215, -102);
            this.timeline.addTween(a.Tween.get(this.instance).wait(1))
        }).prototype = g(b.gr_number, new a.Rectangle(-215, -102, 430, 102), null);
    ...
    (b.___rank = function(c, d, e) {
        this.initialize(c, d, e, {});
        this.instance = new b.result_no4;
        this.instance.parent = this;
    ...
    (b.___character_white = function(c, d, e) {
        this.initialize(c, d, e, {});
        this.instance = new b.result_ch4_white;
        this.instance.parent = this;
        this.instance.setTransform(-464, -620);
        this.timeline.addTween(a.Tween.get(this.instance).wait(1))
    }).prototype = g(b.___character_white, new a.Rectangle(-464, -620, 748, 620), null);
    (b.___character_black = function(c, d, e) {
        this.initialize(c, d, e, {});
        this.instance = new b.result_ch4_black;
        this.instance.parent = this;
        this.instance.setTransform(-464, -620);
        this.timeline.addTween(a.Tween.get(this.instance).wait(1))
    }).prototype =
        g(b.___character_black, new a.Rectangle(-464, -620, 748, 620), null);
    (b.___character = function(c, d, e) {
        this.initialize(c, d, e, {});
        this.instance = new b.result_ch4;
        this.instance.parent = this;
        this.instance.setTransform(-464, -620);
        this.timeline.addTween(a.Tween.get(this.instance).wait(1))
    }).prototype = g(b.___character, new a.Rectangle(-464, -620, 748, 620), null);
    ...
    (b.election_result_4 = function(c, d, e) {
        this.initialize(c, d, e, {
            top5_1: 3,
            top5_2: 25,
            top5_3: 49,
    ...
    b.properties = {
        ...
        manifest: [{
                ...
                id: "election_result_4__005_shuttle_pa"
            }, {
                src: "images/_005_textflame.png",
                id: "election_result_4__005_textflame"
            }, {
                src: "images/bg.jpg",
                id: "election_result_4_bg"
            }, {
                src: "images/bottom.png",
                id: "election_result_4_bottom"
            }, {
                src: "images/fp_flower3.png",
                id: "election_result_4_fp_flower3"
            },
            {
                src: "images/result_ch4.png",
                id: "election_result_4_result_ch4"
            }, {
                src: "images/result_ch4_black.png",
                id: "election_result_4_result_ch4_black"
            }, {
                src: "images/result_ch4_white.png",
                id: "election_result_4_result_ch4_white"
            }, {
                src: "images/result_name4.png",
                id: "election_result_4_result_name4"
            }, {
                src: "images/result_no4.png",
                id: "election_result_4_result_no4"
            }, {
                src: "images/result_no4_white.png",
                id: "election_result_4_result_no4_white"
            }, {
                src: "images/result_sign4.png",
                id: "election_result_4_result_sign4"
            }, {
                src: "images/result_votes4.png",
                id: "election_result_4_result_votes4"
            }, {
                src: "images/sp_kirakira.png",
                id: "election_result_4_sp_kirakira"
            }
        ],
        preloads: []
    };
    ...
    l.compositions.election_result_4 = {
        getStage: function() {
