...
(lib.surprise_container = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(0,-0.1,0.3455,0.3457,0,0,0,0,-0.1);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(2).to({_off:false},0).wait(1).to({regX:7.6,regY:-2,scaleX:1.6381,scaleY:1.6381,x:17.75,y:-8.6},0).wait(1).to({regX:-0.2,regY:-0.1,scaleX:1.9935,scaleY:1.9935,x:6.8,y:-7},0).to({_off:true},1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-21.9,-63.8,88.6,106);
...
(lib.replace = function(mode,startPosition,loop) {
	...
	this.L.name = "L";
	this.L.parent = this;
	this.L.setTransform(-51.3,-53.8,1.3,1.3,0,0,180);

	this.R = new lib.surprise_container();
	this.R.name = "R";
	this.R.parent = this;
	this.R.setTransform(46.4,-56.95,1.3,1.3);
...
// stage content:
(lib.eff_shock2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
