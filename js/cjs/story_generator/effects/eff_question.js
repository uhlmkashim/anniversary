...
(lib.mc_question = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({regX:-0.2,regY:0.2,x:-0.45,y:-15.85,alpha:0.5556},0).wait(1).to({x:-0.2,y:-24.55,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:0.1,y:-27.7,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:-0.1,y:-26.8},0).wait(1).to({y:-24.75},0).wait(1).to({y:-21.35},0).wait(1).to({regX:0,regY:0,x:0.1,y:-16.85},0).to({y:-18.35},2).wait(8).to({regX:-0.2,regY:0.2,x:-0.1,y:-17.5,alpha:0.9298},0).wait(1).to({y:-15.4,alpha:0.692},0).wait(1).to({y:-12.25,alpha:0.339},0).wait(1).to({y:-9.95,alpha:0.0788},0).wait(1).to({regX:0,regY:0,x:0.1,y:-9.45,alpha:0},0).to({_off:true},1).wait(1));
