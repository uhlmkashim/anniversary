(function (cjs, an) {
    ...
    (lib.replace = function(mode,startPosition,loop) {
        ...
        // effect_4
        this.L = new lib.concent_wrapper();
        this.L.name = "L";
        this.L.parent = this;
        this.L.setTransform(-1.8,-5.25,1,1,0,0,0,-0.5,-0.1);
        this.L._off = true;
    
        this.timeline.addTween(cjs.Tween.get(this.L).wait(1).to({_off:false},0).to({_off:true},3).wait(3));
    
        // effect_5
        this.L_1 = new lib.concent_wrapper();
        this.L_1.name = "L_1";
        this.L_1.parent = this;
        this.L_1.setTransform(-1.8,-5.25,1,1,0,0,0,-0.5,-0.1);
        this.L_1._off = true;
    
        this.timeline.addTween(cjs.Tween.get(this.L_1).wait(4).to({_off:false},0).wait(3));
    
    }).prototype = p = new cjs.MovieClip();
    p.nominalBounds = new cjs.Rectangle(-407.6,-407.3,815.3,814.7);
    
    
    // stage content:
    (lib.eff_concent = function(mode,startPosition,loop) {
        this.initialize(mode,startPosition,loop,{});
