...
(lib.cjs003_clock = function(mode,startPosition,loop) {
	...
	this.cjs003_clock.setTransform(500,18.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.cjs003_clock}]}).wait(3));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(489,16,136,28);
...
(lib.gr_number = function(mode,startPosition,loop) {
	...
	// num
	this.instance = new lib.no_0();
	this.instance.setTransform(-10.9,-13.9);

	this.instance_1 = new lib.no_1();
	this.instance_1.setTransform(-5.9,-13.9);

	this.instance_2 = new lib.no_2();
	this.instance_2.setTransform(-10.9,-13.9);

	this.instance_3 = new lib.no_3();
	this.instance_3.setTransform(-10.9,-13.9);

	this.instance_4 = new lib.no_4();
	this.instance_4.setTransform(-10.9,-13.9);

	this.instance_5 = new lib.no_5();
	this.instance_5.setTransform(-10.9,-13.9);

	this.instance_6 = new lib.no_6();
	this.instance_6.setTransform(-10.9,-13.9);

	this.instance_7 = new lib.no_7();
	this.instance_7.setTransform(-10.9,-13.9);

	this.instance_8 = new lib.no_8();
	this.instance_8.setTransform(-10.9,-13.9);

	this.instance_9 = new lib.no_9();
...
(lib.mc_second = function(mode,startPosition,loop) {
	...
	// レイヤー 1
	this.instance = new lib.gr_second();

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).wait(19));
